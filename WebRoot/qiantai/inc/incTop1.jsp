...
<html>
  ...
  <body>
        <center>
        <table width="966" height="73" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td  background="<%=path %>/img/banner.jpg" > 
    	<div style="font-family:宋体; color:#FFFFFF; filter:Glow(Color=#000000,Strength=2); WIDTH: 100%; FONT-WEIGHT: bold; FONT-SIZE: 22pt; margin-top:5px">
   <div align="center" class="STYLE5"> 基于jsp技术的网上书店 </div>
</div> </td>
  </tr>
</table>
        </center>
